  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Abdul Khader - Data Science & Full-Stack Developer from Hyderabad, India. Building innovative solutions with Rust, TypeScript, and Blockchain.' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Abdul Khader - Data Science & Full-Stack Developer from Hyderabad, India.' },
        { hid: 'og:image', property: 'og:image', content: 'demo-share.jpg' },
        { hid: 'og:url', property: 'og:url', content: 'https://invictus596-portfolio.vercel.app/' },
