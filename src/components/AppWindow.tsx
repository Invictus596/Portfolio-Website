  ...
  return (
    <Rnd
      ...
      onResizeStop={(e, direction, ref, delta, position) => {
        try {
          const w = Math.round(parseFloat(ref.style.width)) || 200;
          const h = Math.round(parseFloat(ref.style.height)) || 150;
          setState((prev) => ({
            ...prev,
            width: w,
            height: h,
      ...
      className={`overflow-hidden ${round} ${border} shadow-lg shadow-black/30 ${minimized} bg-c-200`}
      id={`window-${props.id}`}
    >
      <div
      ...
      <div className="innner-window w-full overflow-y-hidden bg-c-200">
